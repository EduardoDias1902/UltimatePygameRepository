...
class Game:
    def __init__(self) -> None:
        ...
        self.tex_wall, self.tex_enemy_frames, self.tex_boss_frames, self.tex_death_frames, self.tex_medkit, self.p_idle, self.p_shoot, self.p_icon, self.s_idle, self.s_shoot, self.s_icon, self.tex_floor, self.tex_ceiling = generate_textures()
